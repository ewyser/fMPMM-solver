...
fi= squeeze(sum(permute(Bp,[2 1 3]).*...
    repmat((permute(sig',[3 2 1])),meD.nDoF(1),1),2).*...
    repmat( permute(vp  ,[3 2 1]) ,meD.nDoF(1),1))                         ;% preprocesing of internal force global vector
