function [mpD,p2] = mpSetupCantileverBeam(meD,ni,ly,xinf,xsup,yinf,coh0,cohr,phi0,phir,n0,rho0,nstr,typeD)
...
yL      = (4+0.5*meD.h(2)/ni):meD.h(2)/ni:  4+BeamThickness   ;

[xl,yl] = meshgrid(xL,yL)                                                 ;
%% MATERIAL POINT:
% SCALAR & VECTOR
mpD.n  = length(xl(:))                                                    ;% number of material point
PF     = 1.0                                                             ;% PIC-FLIP update
mpD.PF = [PF 1-PF]                                                        ;% -
